...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.58/src/main/cljs/clojure/core/reducers.cljs#L33-L44):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── core
                    └── <ins>[reducers.cljs:33-44](https://github.com/clojure/clojurescript/blob/r1.7.58/src/main/cljs/clojure/core/reducers.cljs#L33-L44)</ins>
</pre>
