...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.107/src/main/clojure/cljs/compiler/api.clj#L48-L60):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── compiler
                    └── <ins>[api.clj:48-60](https://github.com/clojure/clojurescript/blob/r1.7.107/src/main/clojure/cljs/compiler/api.clj#L48-L60)</ins>
</pre>
