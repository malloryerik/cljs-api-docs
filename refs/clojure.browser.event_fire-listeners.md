...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.10/src/main/cljs/clojure/browser/event.cljs#L84-L85):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── browser
                    └── <ins>[event.cljs:84-85](https://github.com/clojure/clojurescript/blob/r1.7.10/src/main/cljs/clojure/browser/event.cljs#L84-L85)</ins>
</pre>
