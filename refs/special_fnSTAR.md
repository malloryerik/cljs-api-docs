...
Parser code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.48/src/main/clojure/cljs/analyzer.cljc#L1262-L1333):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[analyzer.cljc:1262-1333](https://github.com/clojure/clojurescript/blob/r1.7.48/src/main/clojure/cljs/analyzer.cljc#L1262-L1333)</ins>
</pre>
