...
Parser code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.10/src/main/clojure/cljs/analyzer.cljc#L1514-L1540):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[analyzer.cljc:1514-1540](https://github.com/clojure/clojurescript/blob/r1.7.10/src/main/clojure/cljs/analyzer.cljc#L1514-L1540)</ins>
</pre>
