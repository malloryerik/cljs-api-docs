...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.10/src/main/cljs/clojure/browser/net.cljs#L19):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── browser
                    └── <ins>[net.cljs:19](https://github.com/clojure/clojurescript/blob/r1.7.10/src/main/cljs/clojure/browser/net.cljs#L19)</ins>
</pre>
