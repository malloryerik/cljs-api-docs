...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.48/src/main/cljs/clojure/set.cljs#L97-L99):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[set.cljs:97-99](https://github.com/clojure/clojurescript/blob/r1.7.48/src/main/cljs/clojure/set.cljs#L97-L99)</ins>
</pre>
