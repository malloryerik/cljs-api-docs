...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.58/src/main/cljs/clojure/string.cljs#L146-L149):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[string.cljs:146-149](https://github.com/clojure/clojurescript/blob/r1.7.58/src/main/cljs/clojure/string.cljs#L146-L149)</ins>
</pre>
