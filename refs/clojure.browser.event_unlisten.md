...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.28/src/main/cljs/clojure/browser/event.cljs#L64-L71):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── browser
                    └── <ins>[event.cljs:64-71](https://github.com/clojure/clojurescript/blob/r1.7.28/src/main/cljs/clojure/browser/event.cljs#L64-L71)</ins>
</pre>
