...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.10/src/main/cljs/clojure/set.cljs#L61-L65):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[set.cljs:61-65](https://github.com/clojure/clojurescript/blob/r1.7.10/src/main/cljs/clojure/set.cljs#L61-L65)</ins>
</pre>
