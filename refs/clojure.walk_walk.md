...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.58/src/main/cljs/clojure/walk.cljs#L37-L52):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[walk.cljs:37-52](https://github.com/clojure/clojurescript/blob/r1.7.58/src/main/cljs/clojure/walk.cljs#L37-L52)</ins>
</pre>
