...
Internal use only.  Create tagged literals with their [syntax form](syntax_tagged-literal.md) instead.
...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.28/src/main/cljs/cljs/core.cljs#L9980-L9985):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[core.cljs:9980-9985](https://github.com/clojure/clojurescript/blob/r1.7.28/src/main/cljs/cljs/core.cljs#L9980-L9985)</ins>
</pre>
...
[edit here]:https://github.com/cljsinfo/cljs-api-docs/blob/master/cljsdoc/cljs.core_tagged-literal.cljsdoc
...
```clj
{:description "Internal use only.  Create tagged literals with their [syntax form](syntax/tagged-literal) instead.",
 :ns "cljs.core",
 :name "tagged-literal",
 :signature ["[tag form]"],
 :history [["+" "0.0-3255"]],
