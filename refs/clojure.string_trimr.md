...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.58/src/main/cljs/clojure/string.cljs#L161-L164):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[string.cljs:161-164](https://github.com/clojure/clojurescript/blob/r1.7.58/src/main/cljs/clojure/string.cljs#L161-L164)</ins>
</pre>
