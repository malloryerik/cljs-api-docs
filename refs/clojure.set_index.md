...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.48/src/main/cljs/clojure/set.cljs#L87-L95):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[set.cljs:87-95](https://github.com/clojure/clojurescript/blob/r1.7.48/src/main/cljs/clojure/set.cljs#L87-L95)</ins>
</pre>
