...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.48/src/main/cljs/clojure/string.cljs#L43-L50):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[string.cljs:43-50](https://github.com/clojure/clojurescript/blob/r1.7.48/src/main/cljs/clojure/string.cljs#L43-L50)</ins>
</pre>
