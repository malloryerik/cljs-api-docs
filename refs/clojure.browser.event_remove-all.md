...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r2127/src/cljs/clojure/browser/event.cljs#L98):
...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[event.cljs:98](https://github.com/clojure/clojurescript/blob/r2127/src/cljs/clojure/browser/event.cljs#L98)</ins>
</pre>
