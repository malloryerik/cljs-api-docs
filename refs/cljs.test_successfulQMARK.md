...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.28/src/main/cljs/cljs/test.cljs#L588-L593):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[test.cljs:588-593](https://github.com/clojure/clojurescript/blob/r1.7.28/src/main/cljs/cljs/test.cljs#L588-L593)</ins>
</pre>
