...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.10/src/main/cljs/cljs/reader.cljs#L69-L71):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[reader.cljs:69-71](https://github.com/clojure/clojurescript/blob/r1.7.10/src/main/cljs/cljs/reader.cljs#L69-L71)</ins>
</pre>
